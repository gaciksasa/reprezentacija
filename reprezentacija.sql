...
CREATE TABLE IF NOT EXISTS `bivsi_klubovi` (
  ...
  `drzava` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sezona` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `stepen_takmicenja` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(5, 104, 'FK Galenika Zemun', NULL, NULL, '1', 18, 4, '2025-03-08 19:16:14', '2025-03-08 19:16:14');
...
CREATE TABLE IF NOT EXISTS `golovi` (
  ...
  `igrac_id` bigint UNSIGNED NOT NULL,
  `igrac_tip` enum('regularni','protivnicki') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'regularni',
  `minut` int NOT NULL,
...
CREATE TABLE IF NOT EXISTS `igraci` (
  ...
  `biografija` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(114, 'Cvetkovič', 'Zvjezdan', 1, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `igraci_klubovi` (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `igrac_id` bigint UNSIGNED NOT NULL,
  `klub` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `drzava_kluba` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `sastavi` (
  ...
  `selektor` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `stadioni` (
  ...
  `zemlja` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `sudije` (
  ...
  `ime` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `prezime` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nacionalnost` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `takmicenja` (
  ...
  `naziv` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `sezona` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `organizator` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `timovi` (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `naziv` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `skraceni_naziv` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `zastava_url` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `grb_url` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `zemlja` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `utakmice` (
  ...
  `sudija` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rezultat_domacin` int NOT NULL DEFAULT '0',
  `rezultat_gost` int NOT NULL DEFAULT '0',
  `publika` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
