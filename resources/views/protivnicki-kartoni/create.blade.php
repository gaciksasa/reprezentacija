...
@section('title', 'Dodaj karton protivničkom igraču')
...
<div class="card">
    <div class="card-header">
        <h5 class="card-title mb-0">Karton za protivnički tim: {{ $tim->naziv }}</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('protivnicki-kartoni.store') }}" method="POST">
            @csrf
