...
@section('title', 'Izmeni tim')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1>Izmeni tim: {{ $tim->naziv }}</h1>
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('timovi.update', $tim) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('naziv') is-invalid @enderror" 
                       id="naziv" name="naziv" value="{{ old('naziv', $tim->naziv) }}" required>
                @error('naziv')
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('skraceni_naziv') is-invalid @enderror" 
                       id="skraceni_naziv" name="skraceni_naziv" value="{{ old('skraceni_naziv', $tim->skraceni_naziv) }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('zastava_url') is-invalid @enderror" 
                       id="zastava_url" name="zastava_url" value="{{ old('zastava_url', $tim->zastava_url) }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('grb_url') is-invalid @enderror" 
                       id="grb_url" name="grb_url" value="{{ old('grb_url', $tim->grb_url) }}">
